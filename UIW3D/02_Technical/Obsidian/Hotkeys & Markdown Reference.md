...
**Inline Code**
- Syntax: Wrap with single backticks
- Example: `` `code` `` → `code`

**Code Block**
- Syntax: Wrap with triple backticks
```python
...
- Syntax: `[[Note Name]]`
- Example: [[../../05_Utility/Proxies/Proxy Note|Proxy Note]]

**Link with Custom Text**
- Syntax: `[[Note Name|Display Text]]`
- Example: [[../../05_Utility/Proxies/Proxy Note| This is a custom name title]]
...
- Example: [Obsidian Documentation](https://obsidian.md)
